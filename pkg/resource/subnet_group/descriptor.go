...
const (
	finalizerString = "finalizers.memorydb.services.k8s.aws/SubnetGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("subnetgroups")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.SubnetGroup{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.SubnetGroup),
	}
}
