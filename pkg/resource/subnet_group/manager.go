...
// +kubebuilder:rbac:groups=memorydb.services.k8s.aws,resources=subnetgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=memorydb.services.k8s.aws,resources=subnetgroups/status,verbs=get;update;patch
