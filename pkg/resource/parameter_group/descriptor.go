...
const (
	finalizerString = "finalizers.memorydb.services.k8s.aws/ParameterGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("parametergroups")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ParameterGroup{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ParameterGroup),
	}
}
