...
// +kubebuilder:rbac:groups=memorydb.services.k8s.aws,resources=parametergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=memorydb.services.k8s.aws,resources=parametergroups/status,verbs=get;update;patch
